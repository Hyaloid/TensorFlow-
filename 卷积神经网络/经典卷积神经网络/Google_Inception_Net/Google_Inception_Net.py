...
def inception_v3_base(inputs, scope=None):
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
        ...
        branch_1 = slim.conv2d(branch_1, 96, [3, 3],
                               scope='Conv2d_0b_3x3')
        brach_1 = slim.conv2d(branch_1, 96, [3, 3], stride=2,
            ...
            with tf.variable_scope('Branch_0'):
                ...
                with tf.variable_scope('Branch_1'):
                    ...
                    branch_1 = slim.conv2d(branch_1, 128, [1, 7],
                                           scope='Conv2d_0b_1x7')
                    branch_1 = slim.conv2d(branch_1, 128, [7, 1],
                                           scope='Conv2d_0c_7x1')
                with tf.variable_scope('Branch_2'):
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3, 192, [1, 1],
                                           scope='Conv2d_0b_1x1')
                    net = tf.concat([brach_0, branch_1, branch_2, branch_3], 3)
        with tf.variable_scope('Mixed_6c'):
            with tf.variable_scope('Branch_0'):
                branch_0 = slim.conv2d(net, 192, [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
            branch_1 = slim.conv2d(ent, 160, [1, 1], scope='Conv2d_0a_1x1')
        ...
        with tf.variable_scope('Mixed_7a'):
            ...
            with tf.variable_scope('Branch_1'):
                ...
                branch_1 = slim.conv2d(branch_1, 192, [3, 3], stride=2,
                                       padding='VALID', scope='Conv2d__1a_3x3')
            with tf.variable_scope('Branch_2'):
                branch_2 = slim.max_pool2d(net, [3, 3], stride=2, padding='VALID',
                                           scope='Conv2d_1a_3x3')
            net = tf.concat([branch_0, branch_1, branch_2], 3)
        ...
        with tf.variable_scope('Mixed_7c'):
            ...
            with tf.variable_scope('Branch_1'):
                branch_1 = slim.conv2d(net, 384, [1,1], scope = 'Conv2d_0a_1x1')
                branch_1 = tf.concat([
                    slim.conv2d(branch_1, 384, [1,1], scope = 'Conv2d_0b_1x3'),
